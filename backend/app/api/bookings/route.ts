...
import { correlationId, domainError, readJson, unauthenticated } from '../../../modules/shared/http';
...
export async function POST(request: Request): Promise<NextResponse> {
  ...
  try {
    ...
    return NextResponse.json({ data: confirmation, correlationId: correlationId() }, { status: 201 });
  } catch (error) {
